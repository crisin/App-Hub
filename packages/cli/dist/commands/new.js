...
export const newCommand = new Command('new')
    ...
    if (!options.template) {
        ...
        const templates = await withSpinner('Loading templates...', () => hubFetch('/api/templates'));
    ...
    const result = await withSpinner(`Creating project "${name}" from template "${options.template}"...`, () => hubFetch('/api/projects', {
        method: 'POST',
